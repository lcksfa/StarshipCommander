...
export default {
  ...
  // Note: <rootDir> points to the config directory, so we use ../ to go up
  ...
  collectCoverageFrom: [
    "<rootDir>/../src/backend/**/*.{ts,js}",
    "!<rootDir>/../src/backend/**/*.d.ts",
    "!<rootDir>/../src/backend/**/*.spec.{ts,js}",
    "!<rootDir>/../src/backend/**/*.test.{ts,js}",
    "!<rootDir>/../src/backend/dist/**",
    "!<rootDir>/../src/backend/**/node_modules/**",
  ],
