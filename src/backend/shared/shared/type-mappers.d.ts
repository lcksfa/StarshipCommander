...
export declare function mapFrontendToDbCategory(
  frontendCategory: FrontendCategory,
): DbCategory;
export declare function mapDbToFrontendCategory(
  dbCategory: DbCategory | string,
): FrontendCategory;
export declare function isValidFrontendCategory(
  category: string,
): category is FrontendCategory;
export declare function isValidDbCategory(
  category: string,
): category is DbCategory;
export declare function getCategoryDisplayName(
...
export declare function createLocalizedText(
  en: string,
  zh?: string,
): LocalizedText;
export declare function getLocalizedText(
  text: LocalizedText,
  language?: "en" | "zh",
): string;
